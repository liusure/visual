...
var MenuList = (function (_super) {
    ...
    MenuList.prototype.render = function () {
        ...
        return (React.createElement("div", { ref: this.refMenuScrollContainer, className: "zent-popup-menu", tabIndex: 0, onKeyDown: this.onKeyDown }, items && items.length ? (React.createElement("ul", { ref: this.refMenuItemList }, this.renderItems(items))) : null));
    };
    return MenuList;
}(Component));
