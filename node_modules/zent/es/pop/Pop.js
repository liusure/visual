...
var PopAction = (function (_super) {
    ...
    PopAction.prototype.render = function () {
        ...
        return (React.createElement("div", { className: prefix + "-pop-buttons" },
...
var Pop = (function (_super) {
    ...
    Pop.prototype.renderContent = function () {
        ...
        return (React.createElement(Popover.Content, null,
            hasHeader && React.createElement("div", { className: prefix + "-pop-header" }, header),
            React.createElement("div", { className: prefix + "-pop-inner" },
                content,
            ...
            React.createElement("i", { className: prefix + "-pop-arrow" })));
    };
