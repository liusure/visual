...
var TimelineItem = (function (_super) {
    ...
    TimelineItem.prototype.render = function () {
        ...
        return (React.createElement("li", { className: cx(prefix + "-timeline-item", className), style: style, onMouseMove: this.onMouseMove },
            React.createElement(TimelineItemOptionalPop, { display: display, tip: tip, prefix: prefix, position: this.position, popoverRef: this.popoverRef },
                React.createElement("div", { className: prefix + "-timeline-item-hover" },
                    React.createElement("div", { className: prefix + "-timeline-item-line", style: (_a = {},
                            _a[key] = size,
                            _a.backgroundColor = color || lineColor,
                            _a) }, showDot && React.createElement(TimelineDot, { color: color || dotColor })))),
            showLabel && (React.createElement("label", { className: prefix + "-timeline-item-label" }, label))));
    };
