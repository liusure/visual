...
var Foot = (function (_super) {
    ...
    Foot.prototype.renderBatchComps = function (selectedRows, batchComponents) {
        return batchComponents.map(function (comp, index) {
            ...
            return (React.createElement("div", { className: "subcomponent-wrapper", key: index }, subComponent));
        });
    };
    ...
    Foot.prototype.render = function () {
        ...
        return (shouldRenderFoot && (React.createElement("div", { className: "tfoot clearfix", style: this.footStyleFixed },
            React.createElement("div", { className: batchClassName, ref: function (c) { return (_this.batch = c); } },
            ...
            React.createElement("div", { className: "tfoot__page" }, Object.keys(pageInfo).length > 0 && (React.createElement(PaginationComp, __assign({ current: current, total: isNil(total) ? totalItem : total, pageSize: isNil(pageSize) ? limit : pageSize, onChange: onPageChange }, restPageInfo)))))));
    };
    return Foot;
}(PureComponent));
export default Foot;
