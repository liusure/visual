...
var Table = (function (_super) {
    ...
    function Table(props) {
        ...
        _this.onSelectOneRow = function (rowKey, isSelect) {
            ...
            if (!selection.needCrossPage) {
                _this.selectedRowKeys = intersection(_this.selectedRowKeys, _this.props.datasets.map(function (item) { return item[_this.props.rowKey]; }));
            }
    ...
    Table.prototype.getSelectedRowsByKeys = function (rowKeys) {
        var rows = [];
        var self = this;
        var allRows = uniqBy(this.selectedRows.concat(this.props.datasets), this.props.rowKey);
    ...
    Table.prototype.render = function () {
        ...
        return (React.createElement(Receiver, { componentName: "Table" }, function (i18n) { return (React.createElement("div", { className: prefix + "-table-container" },
            React.createElement(BlockLoading, { loading: _this.props.loading }, columns && (React.createElement("div", { className: prefix + "-table " + className },
                _this.state.placeHolderHeight && (React.createElement("div", { className: "thead place-holder" })),
