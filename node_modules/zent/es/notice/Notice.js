...
export function Notice(_a) {
    ...
    return (React.createElement("div", { className: cx('zent-notice', { 'zent-notice-with-icon': !!type }, className), style: style },
        renderIcon(type),
        React.createElement("div", { className: "zent-notice-title" }, title),
        closable ? (React.createElement(Icon, { type: "close", className: "zent-notice-close", onClick: onCloseClick })) : null,
        React.createElement("div", { className: "zent-notice-content" }, children)));
}
