...
var BaseTabs = (function (_super) {
    ...
    BaseTabs.prototype.renderWithPanel = function () {
        ...
        return (React.createElement("div", { className: this.tabsCls },
            this.renderNav(tabDataList),
            React.createElement("div", { className: "zent-tabs-panel-wrapper" }, tabDataList.map(this.renderTabPanel.bind(this)))));
    };
    BaseTabs.prototype.renderWithoutPanel = function () {
        var tabs = this.props.tabs;
        return (React.createElement("div", { className: this.tabsCls }, this.renderNav(this.getTabDataListFromTabs(tabs))));
    };
