...
var AnimationHeight = (function (_super) {
    ...
    AnimationHeight.prototype.render = function () {
        ...
        return (React.createElement("div", { ref: this.ref, className: className, style: __assign(__assign({}, style), { transition: "height " + duration + "ms " + easing, overflow: overflow }) }, children));
    };
