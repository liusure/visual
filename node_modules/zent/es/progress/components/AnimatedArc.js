        ...
        return (React.createElement("g", null,
            React.createElement("defs", null,
                React.createElement("linearGradient", { id: GRADIENT_ID },
                    React.createElement("stop", { offset: "0%", stopColor: "rgba(255, 255, 255, 0)" }),
                    React.createElement("stop", { offset: "100%", stopColor: "#fff" }))),
            React.createElement("path", { className: className, d: path, style: __assign({ stroke: "url(#" + GRADIENT_ID + ")", strokeOpacity: opacity, strokeWidth: strokeWidth, transform: "rotate(" + rotate + "rad)" }, transition) })));
    };
