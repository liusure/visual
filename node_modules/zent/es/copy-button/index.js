...
var CopyButton = (function (_super) {
    ...
    CopyButton.prototype.render = function () {
        ...
        return (React.createElement(Receiver, { componentName: "CopyButton" }, function (i18n) { return (React.createElement(CopyToClipboard, { text: text, onCopy: _this.onCopy(i18n) }, children ? (React.Children.only(children)) : (React.createElement(Button, { onClick: onClick, type: "primary" }, i18n.copy)))); }));
    };
