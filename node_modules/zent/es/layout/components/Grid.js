...
var LayoutGrid = (function (_super) {
    ...
    function LayoutGrid() {
        ...
        _this.onBreakpointChange = function (name, matched) {
            _this.setState(function (prevState) {
                ...
                return {
                    breakpoints: pickBy(__assign(__assign({}, breakpoints), (_a = {}, _a[name] = matched, _a))),
                };
            });
        };
        return _this;
    ...
    LayoutGrid.prototype.render = function () {
        ...
        return (React.createElement(ConfigContext.Consumer, null, function (config) {
            ...
            return (React.createElement("div", __assign({}, others, { className: cx('zent-layout-grid', className), style: layoutStyles }),
