...
var DialogInnerEl = (function (_super) {
    ...
    DialogInnerEl.prototype.renderHeader = function () {
        ...
        title =
            typeof title === 'number' || typeof title === 'string' ? (React.createElement("span", { className: prefix + "-dialog-r-title-text" }, title)) : (title);
        return (React.createElement("div", { className: prefix + "-dialog-r-header" },
            React.createElement("div", { className: prefix + "-dialog-r-title" }, title)));
    };
    DialogInnerEl.prototype.render = function () {
        ...
        var closeBtnCls = cx(prefix + "-dialog-r-close", (_a = {},
            ...
            _a));
        var Closer = closeBtn && (React.createElement("button", { type: "button", className: closeBtnCls, onClick: this.onClickClose }, "\u00D7"));
        var Footer = footer && (React.createElement("div", { className: prefix + "-dialog-r-footer" }, footer));
        return (React.createElement("div", { className: prefix + "-dialog-r " + className, style: style, ref: function (el) { return (_this.dialogEl = el); } },
            Closer,
            Header,
            React.createElement("div", { className: prefix + "-dialog-r-body" }, children),
            Footer));
    };
...
var DialogElWrapper = (function (_super) {
    ...
    DialogElWrapper.prototype.render = function () {
        ...
        return (React.createElement("div", { ref: this.rootRef, tabIndex: -1, className: prefix + "-dialog-r-root" },
            visible && mask && React.createElement("div", { className: prefix + "-dialog-r-backdrop" }),
            React.createElement("div", { className: prefix + "-dialog-r-wrap", onClick: this.onMaskClick }, children)));
    };
