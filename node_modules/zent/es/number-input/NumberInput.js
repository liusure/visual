...
var NumberInput = (function (_super) {
    ...
    NumberInput.prototype.renderChild = function (children) {
        ...
        return (React.createElement(React.Fragment, null,
            showCounter && (React.createElement("div", { className: reduceCountClass, onClick: this.dec }, "\u2013")),
            children,
            showCounter && (React.createElement("div", { className: addCountClass, onClick: this.inc }, "+")),
            showStepper && (React.createElement("div", { className: 'zent-number-input-arrows' },
                React.createElement("div", { className: upArrowClass, onClick: this.inc },
                    React.createElement(Icon, { type: "up" })),
                React.createElement("div", { className: downArrowClass, onClick: this.dec },
