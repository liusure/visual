...
export var FormSelectField = function (props) {
    var model;
    if (props.name) {
        var _a = props, name_1 = _a.name, defaultValue = _a.defaultValue;
    ...
    return (React.createElement(FormControl, { ref: anchorRef, className: className, style: style, label: label, required: !!required, invalid: !!model.error },
        React.createElement("div", { className: "zent-form-control-content-inner" },
            before,
            React.createElement(Select, __assign({}, props.props, { onChange: onChange, tags: props.tags, data: props.data, value: model.value })),
            after),
