...
export interface IFormProps<T extends Record<string, BasicModel<unknown>> = any> extends Omit<React.FormHTMLAttributes<HTMLFormElement>, 'onSubmit' | 'dangerouslySetInnerHTML'> {
...
export declare class Form<T extends Record<string, BasicModel<unknown>> = any> extends React.Component<IFormProps<T>> {
