...
var Tree = (function (_super) {
    ...
    Tree.prototype.renderOperations = function (root, isExpanded) {
        ...
        if (opts) {
            var optNodes = opts.map(function (opt) {
                ...
                return (shouldRender(root) && (React.createElement("span", { key: opt.name + "-" + root[id], onClick: opt.action.bind(null, root, isExpanded), className: "opt" },
                    typeof opt.icon === 'string' ? (React.createElement("i", { className: opt.icon })) : (opt.icon),
                    ' ',
                    opt.name)));
            });
            return React.createElement("div", { className: "operation" }, optNodes);
        }
        return null;
    };
            ...
            return roots.map(function (root) {
                ...
                return (React.createElement("li", { key: rootId },
                    ...
                    root[children] && root[children].length > 0 && (React.createElement(AnimateHeight, { appear: true, duration: 200, height: isShowChildren ? 'auto' : 0 },
                        React.createElement("ul", { key: "ul-" + rootId, className: prefix + "-tree-child" }, _this.renderTreeNodes(root[children]))))));
            });
        }
        return null;
    };
    Tree.prototype.render = function () {
        ...
        var classNames = classnames(prefix + "-tree", (_a = {},
            ...
            _a));
        return (React.createElement("ul", { className: classNames, style: commonStyle }, this.renderTreeNodes(tree)));
    };
    Tree.defaultProps = {
