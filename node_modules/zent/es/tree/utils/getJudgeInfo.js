import { DEFAULT_REANDER_KEY, } from './common';
export default function getJudgeInfo(_a) {
    var expandAll = _a.expandAll, loadMore = _a.loadMore, tree = _a.tree, _b = _a.renderKey, renderKey = _b === void 0 ? DEFAULT_REANDER_KEY : _b;
    var expandNode = [];
    var rootInfoMap = {};
