...
var SketchFileds = (function (_super) {
    ...
    SketchFileds.prototype.render = function () {
        ...
        return (React.createElement("div", { style: styles.fields, className: prefix + "-colorpicker-input" },
            React.createElement("div", { style: styles.double },
            ...
            React.createElement("div", { style: styles.single },
