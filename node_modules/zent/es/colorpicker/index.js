    ...
    ColorPicker.prototype.render = function () {
        ...
        return (React.createElement(Popover, { className: cx(prefix + "-color-picker-popover", className), position: Popover.Position.AutoBottomLeft, display: "inline", cushion: 5, visible: popVisible, onVisibleChange: this.handleVisibleChange },
            React.createElement(PopoverClickTrigger, null,
                React.createElement("div", { className: cx(prefix + "-color-picker", wrapperClassName, openClassName), tabIndex: 0 },
                    React.createElement("div", { className: prefix + "-color-picker__text" },
                        React.createElement("div", { className: prefix + "-color-picker__preview", style: { backgroundColor: backgroundColor } })))),
