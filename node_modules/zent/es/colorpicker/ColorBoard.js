...
var Sketch = function (_a) {
    ...
    return (React.createElement("div", { style: styles.picker, className: cx(prefix + "-colorpicker-board", className) },
        React.createElement("div", { style: styles.saturation },
            React.createElement(Saturation, { style: styles.Saturation, hsl: hsl, hsv: hsv, onChange: onChange })),
        React.createElement("div", { style: styles.controls, className: "flexbox-fix" },
            React.createElement("div", { style: styles.sliders },
                React.createElement("div", { style: styles.hue },
                    React.createElement(Hue, { style: styles.Hue, hsl: hsl, onChange: onChange })),
                React.createElement("div", { style: styles.alpha },
