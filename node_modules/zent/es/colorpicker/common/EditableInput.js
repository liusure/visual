...
var EditableInput = (function (_super) {
    ...
    EditableInput.prototype.render = function () {
        ...
        return (React.createElement("div", { style: styles.wrap },
            React.createElement("input", { prefix: "colorpicker-rgb", style: styles.input, ref: this.inputRef, value: this.state.value, onKeyDown: this.handleKeyDown, onChange: this.handleChange, onBlur: this.handleBlur, placeholder: this.props.placeholder }),
            this.props.label ? (React.createElement("span", { style: styles.label, onMouseDown: this.handleMouseDown }, this.props.label)) : null));
    };
