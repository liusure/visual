...
var Saturation = (function (_super) {
    ...
    Saturation.prototype.render = function () {
        ...
        return (React.createElement("div", { style: styles.color, ref: this.containerRef, onMouseDown: this.handleMouseDown, onTouchMove: this.handleChange, onTouchStart: this.handleChange },
            React.createElement("div", { style: styles.white },
                React.createElement("div", { style: styles.black }),
                React.createElement("div", { style: styles.pointer }, this.props.pointer ? (React.createElement(this.props.pointer, __assign({}, this.props))) : (React.createElement("div", { style: styles.circle }))))));
    };
    return Saturation;
}(Component));
