...
var Button = (function (_super) {
    ...
    Button.prototype.render = function () {
        ...
        var child;
        if (href || target) {
            child = (React.createElement("a", __assign({ href: disabled || loading ? undefined : href || '', target: target, download: download }, props), children));
        }
        else {
            child = (React.createElement("button", __assign({ type: htmlType, disabled: !!(disabled || loading) }, props), children));
        }
