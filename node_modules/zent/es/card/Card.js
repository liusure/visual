...
var Card = (function (_super) {
    ...
    Card.prototype.render = function () {
        ...
        return (React.createElement("div", { className: cx(prefix + "-card", className, (_a = {},
                ...
                _a)), style: style },
            (isValidTitle || isValidAction) && (React.createElement("div", { className: prefix + "-card-header" },
                isValidTitle && (React.createElement("h3", { className: prefix + "-card-header__title" }, title)),
                isValidAction && (React.createElement("div", { className: prefix + "-card-header__action" }, action)))),
            React.createElement("div", { className: prefix + "-card-body", style: bodyStyle }, loading ? React.createElement(Placeholder.TextBlock, { rows: 5 }) : children)));
    };
    Card.defaultProps = {
        type: 'normal',
        style: {},
