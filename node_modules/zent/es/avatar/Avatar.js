...
var Avatar = (function (_super) {
    ...
    Avatar.prototype.render = function () {
        ...
        var cls = cx(prefix + "-avatar", className, (_a = {},
            ...
            _a));
        if (useImage) {
            return (React.createElement("span", { style: style, className: cls },
                React.createElement("img", { className: prefix + "-avatar-image", src: src, alt: "avatar" })));
        }
        if (icon) {
            return (React.createElement("span", { style: style, className: cls },
        ...
        var avatarStyle = isNumber(size)
            ? __assign({ width: size + "px", height: size + "px", lineHeight: size + "px" }, style) : style;
        return (React.createElement("span", { style: avatarStyle, className: cls, ref: this.avatarNodeRef },
            React.createElement("span", { className: prefix + "-avatar-string", style: textStyle, ref: this.textNodeRef }, children)));
    };
