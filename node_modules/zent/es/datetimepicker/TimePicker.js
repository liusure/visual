...
var TimePicker = (function (_super) {
            ...
            if (isPanelOpen) {
                ...
                var radioButtonGroup = [
                    ...
                    return (React.createElement("span", { key: tabKey, className: cx('time__number', {
                        ...
                        }), onClick: function () { return _this.switchTab(tabKey); } }, content));
                });
                return (React.createElement("div", { className: "time-picker time-panel time-picker-panel" },
                    React.createElement("div", { className: "panel__header time-picker-panel__header" },
                        React.createElement("div", { className: cx('time-picker-panel__tab-group', {
                                'show-second': showSecond,
                            }) }, radioButtonGroup)),
                    React.createElement("div", { className: "time-picker-panel__content" }, _this.renderPanelContent(i18n)),
                    _this.props.isFooterVisble ? (React.createElement("div", { className: "time-picker-panel__footer" },
    ...
    TimePicker.prototype.render = function () {
        ...
        return (React.createElement("div", { style: widthStyle, className: wrapperCls },
            React.createElement(Receiver, { componentName: "TimePicker" }, function (i18n) { return (React.createElement(Popover, { cushion: 5, visible: isPanelOpen, onVisibleChange: _this.togglePicker, className: prefix + "-datetime-picker-popover " + className + "-popover", position: popPositionMap[popPosition.toLowerCase()] },
                React.createElement(Popover.Trigger.Click, null,
                    React.createElement("div", { style: widthStyle, className: inputCls, onClick: function (evt) { return evt.preventDefault(); } },
                        ...
                        React.createElement("span", { className: "zenticon zenticon-clock-o" }),
                        canClear && (React.createElement("span", { onClick: _this.onClearInput, className: "zenticon zenticon-close-circle" })))),
                React.createElement(Popover.Content, null, _this.renderPicker(i18n)))); })));
    };
    TimePicker.defaultProps = __assign(__assign({}, commonProps), { placeholder: '', format: 'HH:mm:ss', isFooterVisble: true, hourStep: 1, minuteStep: 1, secondStep: 1, disabledTime: function () { } });
    return TimePicker;
}(PureComponent));
export { TimePicker };
