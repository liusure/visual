...
var DatePanelBody = (function (_super) {
    ...
    DatePanelBody.prototype.render = function () {
        ...
        return (React.createElement("div", { className: "date-table panel-table" },
            React.createElement("ul", { className: "panel-table__row panel-table__head" }, i18n.panel.dayNames.map(function (item, i) { return (React.createElement("li", { key: i }, item)); })),
