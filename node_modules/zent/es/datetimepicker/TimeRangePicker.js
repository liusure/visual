...
var TimeRangePicker = (function (_super) {
    ...
    TimeRangePicker.prototype.renderPicker = function () {
        ...
        rangePicker = (React.createElement("div", { className: cx(className, 'range-picker2') },
            ...
            React.createElement(Receiver, { componentName: "TimePicker" }, function (i18n) { return React.createElement("span", { className: "picker-seperator" }, i18n.to); }),
    ...
    TimeRangePicker.prototype.render = function () {
        ...
        return React.createElement("div", { className: prefixCls }, this.renderPicker());
    };
    TimeRangePicker.defaultProps = __assign(__assign({}, commonProps), { format: 'HH:mm:ss', isFooterVisble: true, hourStep: 1, minuteStep: 1, secondStep: 1, disabledDate: noop, placeholder: ['', ''], value: [], openPanel: [], showSecond: false, disabledTime: function () { } });
