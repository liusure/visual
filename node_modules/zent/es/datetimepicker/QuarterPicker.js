...
var QuarterPicker = (function (_super) {
    ...
    QuarterPicker.prototype.renderPicker = function (i18n) {
        ...
        var quarterPicker;
        if (openPanel) {
            quarterPicker = (React.createElement("div", { className: "quarter-picker", ref: function (ref) { return (_this.picker = ref); } },
        ...
        return (React.createElement("div", { style: widthStyle, className: wrapperCls },
            React.createElement(Receiver, { componentName: "TimePicker" }, function (i18n) {
                ...
                if (selected) {
                    inputVal =
                        i18n.mark === 'zh-CN'
                            ? selected.getFullYear() + "\u5E74" + i18n.panel.quarterNames[value]
                            : i18n.panel.quarterNames[value] + " of " + selected.getFullYear();
                }
