...
var MonthPicker = (function (_super) {
    ...
    function MonthPicker(props) {
        ...
        _this.onSelectMonth = function (val, isYear) {
            ...
            var _a = _this.props, onClick = _a.onClick, isFooterVisble = _a.isFooterVisble;
    ...
    MonthPicker.prototype.renderPicker = function (i18n) {
        var _this = this;
        var _a = this, _b = _a.props, confirmText = _b.confirmText, isFooterVisble = _b.isFooterVisble, _c = _a.state, actived = _c.actived, openPanel = _c.openPanel, selected = _c.selected;
        var monthPicker;
        if (openPanel) {
            ...
            monthPicker = (React.createElement("div", { className: monthPickerCls },
                ...
                isFooterVisble ? (React.createElement(PanelFooter, { buttonText: confirmText || i18n.confirm, linkText: i18n.current.month, linkCls: "link--current", onClickLink: function () { return _this.onSelectMonth(CURRENT); }, onClickButton: this.onConfirm })) : null));
        }
        return monthPicker;
    };
        ...
        return (React.createElement("div", { style: widthStyle, className: wrapperCls },
            React.createElement(Receiver, { componentName: "TimePicker" }, function (i18n) { return (React.createElement(Popover, { cushion: 5, visible: openPanel, onVisibleChange: _this.togglePicker, className: cx(prefix + "-datetime-picker-popover", className), position: popPositionMap[popPosition.toLowerCase()] },
                React.createElement(Popover.Trigger.Click, null,
                    React.createElement("div", { style: widthStyle, className: inputCls },
                        ...
                        React.createElement("span", { className: "zenticon zenticon-calendar-o" }),
