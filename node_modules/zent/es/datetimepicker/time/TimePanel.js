...
var TimePanel = (function (_super) {
    ...
    TimePanel.prototype.render = function () {
        ...
        return (React.createElement("div", { className: "time-panel" },
            ...
            React.createElement("div", { className: "time-panel__preview" },
                React.createElement("span", { className: "time__number", onClick: this.openPanel('hour') },
                    padLeft(actived.getHours()),
                    i18n.panel.hour),
                React.createElement("span", { className: "time__number", onClick: this.openPanel('minute') },
                    padLeft(actived.getMinutes()),
                    i18n.panel.minute),
                React.createElement("span", { className: "time__number", onClick: this.openPanel('second') },
