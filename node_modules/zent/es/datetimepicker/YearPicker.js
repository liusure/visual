...
var YearPicker = (function (_super) {
    ...
    function YearPicker(props) {
        ...
        _this.onSelectYear = function (val) {
            if (_this.isDisabled(val))
                return;
            var _a = _this, _b = _a.props, isFooterVisble = _b.isFooterVisble, onChange = _b.onChange, actived = _a.state.actived;
            var acp = new Date(actived);
            acp.setFullYear(val);
            if (!isFooterVisble) {
                _this.setState({
    ...
    YearPicker.prototype.renderPicker = function () {
        ...
        var yearPicker;
        if (state.openPanel) {
            yearPicker = (React.createElement(Receiver, { componentName: "TimePicker" }, function (i18n) { return (React.createElement("div", { className: "year-picker", ref: function (ref) { return (_this.picker = ref); } },
            ...
            React.createElement(Popover, { cushion: 5, visible: openPanel, onVisibleChange: this.togglePicker, className: prefix + "-datetime-picker-popover " + className + "-popover", position: popPositionMap[popPosition.toLowerCase()] },
                React.createElement(Popover.Trigger.Click, null,
                    React.createElement("div", { style: widthStyle, className: inputCls },
                        ...
                        canClear && (React.createElement("span", { onClick: this.onClearInput, className: "zenticon zenticon-close-circle" })))),
