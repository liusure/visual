...
var ClampLines = (function (_super) {
    ...
    ClampLines.prototype.renderClampedText = function () {
        ...
        var classString = cx((_a = {},
            ...
            _a));
        return (React.createElement("div", { className: classString, style: { maxHeight: this.maxHeight, overflowY: 'hidden' } },
            React.createElement("div", { ref: function (e) { return (_this.element = e); } },
                React.createElement("span", { ref: function (e) { return (_this.innerElement = e); } }, this.state.text),
                this.props.extra),
    ...
    ClampLines.prototype.render = function () {
        ...
        if (showPop) {
            return (React.createElement(Pop, { trigger: trigger, content: React.createElement("div", { style: { maxWidth: popWidth } }, renderPop(text)) }, this.renderClampedText()));
        }
