...
var TabsContent = (function (_super) {
    ...
    TabsContent.prototype.renderCascaderItems = function (items, stage, popover) {
        ...
        var cascaderItems = items.map(function (item) {
            ...
            var cascaderItemCls = classnames((_a = {},
                ...
                _a));
            return (React.createElement("div", { className: prefix + "-cascader__list-item", key: item.id },
                React.createElement("span", { className: cascaderItemCls, title: item.title, onClick: function () { return clickHandler(item, stage, popover); } }, item.title)));
        });
        return React.createElement("div", { className: prefix + "-cascader__list" }, cascaderItems);
    };
    TabsContent.prototype.renderTabTitle = function (title, stage) {
        ...
        if (isLoading && stage === loadingStage) {
            return (React.createElement("div", { className: prefix + "-cascader__loading" },
                React.createElement("div", { className: prefix + "-cascader__loading-label" }, title),
                React.createElement("div", { className: prefix + "-cascader__loading-icon" })));
        }
        return title;
    };
    ...
    TabsContent.prototype.render = function () {
        ...
        return (React.createElement("div", { className: prefix + "-cascader__popup-inner" },
