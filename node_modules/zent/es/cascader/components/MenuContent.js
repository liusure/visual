...
var MenuContent = (function (_super) {
    ...
    MenuContent.prototype.getMenuItemIcon = function (item, isShowLoading, isActive) {
        ...
        if (item.children || item.isLeaf === false) {
            if (isShowLoading && isActive) {
                return (React.createElement("i", { className: prefix + "-cascader__menu-item-loading zenticon" }));
            }
    ...
    MenuContent.prototype.renderCascaderItems = function (items, stage, popover) {
        ...
        return (React.createElement("ul", { key: stage, className: prefix + "-cascader__menu" }, cascaderItems));
    };
    ...
    MenuContent.prototype.render = function () {
        ...
        return (React.createElement("div", { className: prefix + "-cascader__popup-inner " + prefix + "-cascader__popup-inner-menu" }, this.renderPanels(popover)));
    };
    return MenuContent;
}(PureComponent));
