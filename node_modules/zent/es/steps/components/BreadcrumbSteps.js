...
var BreadcrumbSteps = (function (_super) {
    ...
    BreadcrumbSteps.prototype.render = function () {
        ...
        var stepsCls = cx(prefix + "-steps", className, (_a = {},
            ...
            _a));
        return (React.createElement("div", { className: stepsCls }, React.Children.map(children, function (item, index) {
            ...
            return (React.createElement("div", { className: stepClassName, style: { width: stepWidth }, onClick: function () { return _this.onStepChange(index + 1); } },
                React.createElement("div", { className: prefix + "-steps-step" }, sequence ? index + 1 + ". " + itemTitle : itemTitle)));
        })));
    };
