...
var MiniPagination = (function (_super) {
    ...
    MiniPagination.prototype.render = function () {
        var _a = this.props, current = _a.current, buttonBordered = _a.buttonBordered, className = _a.className;
        ...
        return (React.createElement("div", { className: cx("zent-pagination zent-pagination--" + this.name, className) },
            React.createElement(MiniPageList, { layout: layout, current: current, onPageChange: this.onPageChange, buttonBordered: buttonBordered })));
    };
