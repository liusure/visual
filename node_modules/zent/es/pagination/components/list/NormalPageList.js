...
var NormalPageList = (function (_super) {
    ...
    NormalPageList.prototype.render = function () {
        var _this = this;
        var _a = this.props, layout = _a.layout, buttonBordered = _a.buttonBordered;
        var activeDoubleArrowButton = this.state.activeDoubleArrowButton;
        return (React.createElement("div", { className: "zent-pagination-page-list--normal" }, layout.map(function (btn) {
            var type = btn.type;
            if (type === 'number') {
            ...
            if (type === 'right-arrow') {
                return (React.createElement(ArrowButton, { direction: "right", disabled: btn.disabled, key: type, bordered: buttonBordered, onClick: _this.onNextPage }));
            }
