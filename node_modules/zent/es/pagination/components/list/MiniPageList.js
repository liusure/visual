...
var MiniPageList = (function (_super) {
    ...
    MiniPageList.prototype.render = function () {
        var _this = this;
        var _a = this.props, layout = _a.layout, buttonBordered = _a.buttonBordered, current = _a.current, onPageChange = _a.onPageChange;
        return (React.createElement("div", { className: "zent-pagination-page-list--mini" }, layout.map(function (btn) {
            var type = btn.type;
            if (type === 'left-arrow') {
            ...
            if (type === 'right-arrow') {
                return (React.createElement(ArrowButton, { key: type, direction: "right", disabled: btn.disabled, bordered: buttonBordered, onClick: _this.onNextPage }));
            }
            if (type === 'mini-jumper') {
