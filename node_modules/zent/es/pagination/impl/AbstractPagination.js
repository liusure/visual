...
var AbstractPagination = (function (_super) {
    ...
    AbstractPagination.prototype.render = function () {
        ...
        var _a = this.props, current = _a.current, pageSize = _a.pageSize, pageSizeOptions = _a.pageSizeOptions, showQuickJumper = _a.showQuickJumper, showSizeChanger = _a.showSizeChanger, buttonBordered = _a.buttonBordered, className = _a.className, formatTotal = _a.formatTotal;
        var total = this.getTotal();
        return (React.createElement("div", { className: cx("zent-pagination zent-pagination--" + this.name, className) },
            ...
            React.createElement(NormalPageList, { layout: layout, current: current, buttonBordered: buttonBordered, onPageChange: this.onPageChange }),
