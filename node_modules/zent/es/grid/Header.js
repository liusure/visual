...
var Header = (function (_super) {
    ...
    function Header(props) {
        ...
        _this.getChildren = function (column, props) {
            ...
            var cn = classnames(prefix + "-grid-thead-sort", (_a = {},
                ...
                _a));
            if (column.needSort) {
                return (React.createElement("div", { onClick: function () { return _this.onSort(column, props); }, className: prefix + "-grid-thead-sort-btn" },
                    column.title,
    ...
    Header.prototype.renderThead = function () {
        ...
        return (React.createElement("thead", { className: prefix + "-grid-thead" }, (rows || []).map(function (row, index) {
            var height = fixed && headerHeight
                ? headerHeight / rowsLen
                : undefined;
            return (React.createElement("tr", { key: index, className: prefix + "-grid-tr", style: {
                    height: height,
                } }, row.map(function (props) { return (React.createElement("th", __assign({}, props))); })));
        })));
    };
    Header.prototype.render = function () {
        ...
        return scroll.y ? (React.createElement("table", { className: prefix + "-grid-table", style: headerStyle },
