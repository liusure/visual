...
var Body = (function (_super) {
    ...
    Body.prototype.getRows = function () {
        ...
        var row = [];
        forEach(datasets, function (data, index) {
            row.push(React.createElement(Row, { data: data, columns: columns, index: index, rowIndex: index, prefix: prefix, key: rowKey ? get(data, rowKey) : index, rowClassName: rowClassName, mouseOverRowIndex: mouseOverRowIndex, onRowClick: onRowClick, onRowMouseEnter: onRowMouseEnter, fixed: fixed, scroll: scroll, fixedColumnsBodyRowsHeight: fixedColumnsBodyRowsHeight, row: components && components.row, rowProps: rowProps }));
            if (expandRender && expandRowKeys.length > 0) {
                ...
                if (fixed !== 'right') {
                    row.push(React.createElement("tr", __assign({}, trProps),
                        React.createElement("td", null),
                        React.createElement("td", { colSpan: columns.length - 1 }, expandRender(data))));
                }
                else {
                    row.push(React.createElement("tr", __assign({}, trProps),
    ...
    Body.prototype.renderTbody = function () {
        ...
        var tbodyClass = classnames(prefix + "-grid-tbody", (_a = {},
            ...
            _a));
        return (React.createElement("tbody", { onMouseLeave: this.onBodyMouseLeave, className: tbodyClass }, this.getRows()));
    };
    Body.prototype.render = function () {
        ...
        return scroll.y ? (React.createElement("table", { className: prefix + "-grid-table", style: bodyStyle },
