...
var Swiper = (function (_super) {
    ...
    function Swiper() {
        ...
        _this.init = function (isResetToOrigin) {
            ...
            forEach(innerElements, function (item) {
                setStyle(item, {
    ...
    Swiper.prototype.render = function () {
        ...
        return (React.createElement("div", { ref: this.getSwiper, className: classString, onMouseEnter: this.handleMouseEnter, onMouseLeave: this.handleMouseLeave },
            arrows && childrenCount > 1 && (React.createElement("div", { className: prefix + "-swiper__arrow " + prefix + "-swiper__arrow-left", onClick: this.prev },
                React.createElement(Icon, { type: "right-circle", className: prefix + "-swiper__arrow-icon" }))),
            arrows && childrenCount > 1 && (React.createElement("div", { className: prefix + "-swiper__arrow " + prefix + "-swiper__arrow-right", onClick: this.next },
                React.createElement(Icon, { type: "right-circle", className: prefix + "-swiper__arrow-icon" }))),
            React.createElement("div", { ref: this.getSwiperContainer, className: prefix + "-swiper__container" }, Children.map(clonedChildren, function (child, index) {
