...
var Affix = (function (_super) {
    ...
    Affix.prototype.render = function () {
        ...
        return (React.createElement("div", { className: placeHoldClassName, style: this.state.placeHoldStyle },
            React.createElement("div", { className: wrapClass, style: __assign({}, this.getStyleObj()) }, children),
