...
export function Checkbox(props) {
    ...
    var _3 = props.checked, className = props.className, style = props.style, _1 = props.disabled, _2 = props.readOnly, children = props.children, indeterminate = props.indeterminate, width = props.width, value = props.value, others = __rest(props, ["checked", "className", "style", "disabled", "readOnly", "children", "indeterminate", "width", "value"]);
    ...
    return (React.createElement("label", { className: cx('zent-checkbox-wrap', className, {
        ...
        }), style: __assign({}, getWidth(width)) },
        React.createElement("span", { className: "zent-checkbox" },
            React.createElement("span", { className: "zent-checkbox-inner" }),
            React.createElement("input", __assign({}, others, { type: "checkbox", checked: checked && !indeterminate, disabled: disabled, readOnly: readOnly, onChange: onChange }))),
        children !== undefined &&
            children !== null &&
            children !== true &&
            children !== false ? (React.createElement("div", { className: "zent-checkbox-label" }, children)) : null));
}
