...
var DateRangeQuickPicker = (function (_super) {
    ...
    DateRangeQuickPicker.prototype.render = function () {
        ...
        return (React.createElement("div", { className: cx(prefix + "-date-range-picker", className) },
            ...
            React.createElement("div", { className: prefix + "-date-range-picker__filter" }, preset.map(function (item, index) { return (React.createElement(Receiver, { key: index, componentName: "RangePicker" }, function (i18n) { return (React.createElement("span", { key: index, className: cx(prefix + "-date-range-picker__btn", {
                    active: isEqual(chooseDays, item.value),
                }), onClick: _this.handleChooseDays.bind(_this, item.value) }, item.text || (isNumber(item.value) ? i18n[item.value] : ''))); })); }))));
    };
