...
var Popover = (function (_super) {
    ...
    function Popover(props) {
        ...
        _this.onTriggerRefChange = function (triggerInstance, nodeFilter) {
            var node = triggerInstance
                ...
                : undefined;
            _this.triggerNode = isFunction(nodeFilter) ? nodeFilter(node) : node;
    ...
    Popover.prototype.isVisibilityControlled = function (props) {
        ...
        var hasOnChange = isFunction(onVisibleChange);
        var hasVisible = isBoolean(visible);
    ...
    Popover.prototype.render = function () {
        ...
        var visible = this.getVisible();
        return (React.createElement("div", { style: __assign({ display: display }, getWidth(width)), className: cx(prefix + "-popover-wrapper", wrapperClassName) },
