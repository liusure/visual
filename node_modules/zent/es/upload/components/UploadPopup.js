...
var UploadPopup = (function (_super) {
    ...
    UploadPopup.prototype.renderUploadGroup = function (props) {
        ...
        return (React.createElement("div", { className: prefix + "-group-region" },
            React.createElement("div", { className: prefix + "-title" },
                i18n.popup.group,
                "\uFF1A"),
    ...
    UploadPopup.prototype.renderNetworkRegion = function (props) {
        ...
        return (React.createElement("div", { className: prefix + "-network-image-region" },
            React.createElement("div", { className: prefix + "-title" },
                i18n.popup.web,
                "\uFF1A"),
            React.createElement("div", { className: prefix + "-content" },
                React.createElement("div", { className: prefix + "-input-append" },
                ...
                React.createElement("div", { className: prefix + "-image-preview" },
                    React.createElement("img", { src: networkImage.attachment_url, alt: "" })))));
    };
    ...
    UploadPopup.prototype.renderLocalVoice = function (item, index) {
        var prefix = this.props.prefix;
        return (React.createElement("li", { key: index, className: prefix + "-voice-item" },
            React.createElement("div", { className: prefix + "-voice-item__icon" }),
            React.createElement("div", { className: prefix + "-voice-item__name" }, item.file.name),
            React.createElement("div", { className: prefix + "-voice-item__createtime" }, formatFileSize(item.file.size)),
            React.createElement("span", { className: prefix + "__close-modal", onClick: this.handleDelete.bind(this, index) }, "\u00D7"),
            item.progress ? (React.createElement("div", { className: prefix + "-voice-item__progress" }, item.progress.toFixed(1) + "%")) : ('')));
    };
    UploadPopup.prototype.renderLocalUploadRegion = function (props) {
        ...
        return (React.createElement("div", { className: prefix + "-local-attachment-region" },
            React.createElement("div", { className: prefix + "-title" }, i18n.popup["title_" + options.type] + "\uFF1A"),
            React.createElement("div", { className: prefix + "-content" },
                filesLength > 0 && (React.createElement("ul", { ref: this.onListRefChange, className: prefix + "__upload-local-" + options.type + "-list" }, localFiles.map(function (item, index) {
                    return options.type === 'voice'
                        ? _this.renderLocalVoice(item, index)
                        : _this.renderLocalImage(item, index);
                }))),
                !options.maxAmount || localFiles.length < options.maxAmount ? (React.createElement("div", { className: prefix + "-add-local-image-button pull-left" },
                ...
                React.createElement("div", { className: prefix + "-local-tips c-gray" }, i18n.popup.type({
    ...
    UploadPopup.prototype.renderFooterRegion = function () {
        ...
        return (React.createElement("div", { className: prefix + "__footer" },
