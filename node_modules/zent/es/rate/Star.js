...
var Star = (function (_super) {
    ...
    Star.prototype.render = function () {
        ...
        return (React.createElement("li", { ref: this.elRef, className: this.getClassName(), onClick: disableEdit ? undefined : onClick, onMouseMove: disableEdit ? undefined : onHover },
            React.createElement("div", { className: prefix + "-rate-star-first", style: readOnly ? { width: this.getFloatValue() } : undefined }, character),
            React.createElement("div", { className: prefix + "-rate-star-second" }, character)));
    };
    return Star;
}(Component));
export default Star;
