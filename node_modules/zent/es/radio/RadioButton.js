...
export function RadioButton(props) {
    ...
    return (React.createElement("label", { className: classString, style: wrapStyle },
        React.createElement("input", __assign({}, others, { type: "radio", checked: !!checked, disabled: disabled, readOnly: readOnly, onChange: onChange })),
        React.createElement("span", { className: "zent-radio-button__content" }, children)));
}
