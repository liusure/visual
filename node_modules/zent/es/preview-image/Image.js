...
var Image = (function (_super) {
    ...
    Image.prototype.render = function () {
        ...
        return (React.createElement(Portal, { visible: true, onClose: this.onClose, className: cx(prefix + "-image-p-anchor", className), closeOnESC: true, blockPageScroll: true },
            React.createElement("div", { className: prefix + "-image-p-backdrop" },
                React.createElement("div", { className: prefix + "-image-p-wrap" },
                    React.createElement("div", { className: prefix + "-image-p-close", onClick: this.onClose },
                        React.createElement(Icon, { type: "close" })),
                    React.createElement(Receiver, { componentName: "PreviewImage" }, function (i18n) { return (React.createElement("div", { className: prefix + "-image-p-body", onClick: _this.onMaskClick }, images.map(function (image, index) {
                        if (index === imageIndex) {
                            return (React.createElement("img", { className: imageClassName, onClick: _this.handleScale, style: imageStyle, src: image, key: index, alt: i18n.alt }));
                        }
                        return null;
                    }))); }),
                    React.createElement(Receiver, { componentName: "PreviewImage" }, function (i18n) {
                        ...
                        return (React.createElement("div", { className: footerCxs },
                            needPager && (React.createElement("span", { className: prefix + "-image-p-action", onClick: _this.handlePreviousAction }, i18n.prev)),
                            showRotateBtn && (React.createElement("span", { className: rotateCxs, onClick: debounce(_this.handleRotate, 200) }, i18n.rotate)),
                            needPager && (React.createElement("span", { className: prefix + "-image-p-action", onClick: _this.handleNextAction }, i18n.next))));
                    })))));
    };
    Image.defaultProps = {
        className: '',
