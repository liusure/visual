...
var Badge = (function (_super) {
    ...
    Badge.prototype.renderCount = function () {
        ...
        if (dot) {
            return React.createElement("span", { className: prefix + "-badge-dot", style: badgeStyle });
        }
        else if (count > 0 || (count === 0 && showZero)) {
            return (React.createElement("span", { className: prefix + "-badge-count", style: badgeStyle }, count > maxCount ? maxCount + "+" : count));
        }
        return null;
    };
    Badge.prototype.render = function () {
        ...
        return (React.createElement("div", { className: containerCls },
            children ? (React.createElement("div", { className: prefix + "-badge-content" }, children)) : null,
            this.renderCount()));
    };
    Badge.defaultProps = {
        count: 0,
