...
var PopupMenu = (function (_super) {
    ...
    PopupMenu.prototype.render = function () {
        ...
        return (React.createElement("ul", { className: cx(prefix + "-menu", prefix + "-submenu-content", overlayCx), onClick: this.onSubMenuClick }, React.Children.map(children, this.renderSubMenuItems)));
    };
    return PopupMenu;
}(CommonMenu));
