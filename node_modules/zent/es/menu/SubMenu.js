...
var SubMenu = (function (_super) {
    ...
    SubMenu.prototype.renderContent = function () {
        ...
        return (React.createElement(AnimateHeight, { duration: 200, height: isExpand ? 'auto' : 0 },
            React.createElement("ul", { className: prefix + "-menu__inner" }, React.Children.map(children, this.renderInlineChild))));
    };
    SubMenu.prototype.render = function () {
        ...
        var cls = cx(className, (_a = {},
            ...
            _a));
        return (React.createElement("li", __assign({ className: cls }, eventHanders),
            React.createElement("div", { className: cx((_b = {},
                    ...
                    _b)), style: styleObj, onClick: this.titleClickHandler },
                title,
