...
var TagsTrigger = (function (_super) {
    ...
    TagsTrigger.prototype.render = function () {
        ...
        return (React.createElement(Receiver, { componentName: "Select" }, function (i18n) { return (React.createElement("div", { className: rootClass, onClick: onClick }, selectedItems.length > 0 ? (selectedItems.map(function (item, index) {
            return (React.createElement(Tag, __assign({}, _this.props, { key: index, cid: item.cid }, item, { onDelete: _this.deleteTagHandler })));
        })) : (React.createElement("span", { className: prefixCls + "-placeholder" }, placeholder || i18n.input)))); }));
    };
