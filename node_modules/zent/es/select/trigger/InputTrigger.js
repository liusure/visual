...
var InputTrigger = (function (_super) {
    ...
    InputTrigger.prototype.render = function () {
        ...
        return (React.createElement(Receiver, { componentName: "Select" }, function (i18n) { return (React.createElement("input", { ref: function (input) { return (_this.input = input); }, className: rootClass, placeholder: placeholder || i18n.input, type: "text", value: keyword === null ? text : keyword, onChange: _this.inputChangeHandler, onClick: _this.props.onClick })); }));
    };
    return InputTrigger;
}(Component));
