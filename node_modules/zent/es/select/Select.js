...
var Select = (function (_super) {
    ...
    function Select(props) {
        ...
        _this.optionChangedHandler = function (ev, selectedItem) {
            ...
            var _a = _this.props, onEmptySelected = _a.onEmptySelected, optionValue = _a.optionValue, optionText = _a.optionText, tags = _a.tags, onChange = _a.onChange;
            var selectedItems = _this.state.selectedItems;
            if (!selectedItem) {
                onEmptySelected(ev);
                return;
