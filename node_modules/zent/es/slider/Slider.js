...
var Slider = (function (_super) {
    ...
    Slider.prototype.render = function () {
        ...
        return (React.createElement("div", { className: cx('zent-slider', className, {
            ...
            React.createElement("div", { ref: this.containerRef, className: "zent-slider-main", onMouseDown: this.onMouseDown },
            ...
            withInput &&
                !dots &&
                (computed.range === true ? (React.createElement("div", { className: "zent-slider-input" },
                    React.createElement(NumberInput, __assign({ key: "number-input-left" }, computed.leftProps)),
                    React.createElement("div", { className: "slider-input-line" }, "-"),
