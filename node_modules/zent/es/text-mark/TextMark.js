...
export function TextMark(_a) {
    ...
    var highlightStyles;
    return (React.createElement("span", __assign({ className: className }, rest), chunks.map(function (chunk, index) {
        var _a;
        ...
        if (chunk.highlight) {
            ...
            return (React.createElement("span", { key: index, className: unhighlightClassName, style: unhighlightStyle }, text));
        }
    })));
}
